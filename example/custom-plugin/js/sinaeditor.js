...
SinaEditor.TOOLCONF.faceSrc = [
	{'src':'http://www.sinaimg.cn/uc/myshow/blog/misc/gif/E___7401ZH00SIGG.gif' , 'title':'左哼哼'},
	{'src':'http://www.sinaimg.cn/uc/myshow/blog/misc/gif/E___7400ZH00SIGG.gif' , 'title': '右哼哼'},
	{'src':'http://www.sinaimg.cn/uc/myshow/blog/misc/gif/E___7400ZH00SIGG.gif' , 'title': '右哼哼'},
	{'src':'http://www.sinaimg.cn/uc/myshow/blog/misc/gif/E___7400ZH00SIGG.gif' , 'title': '右哼哼'},
	{'src':'http://www.sinaimg.cn/uc/myshow/blog/misc/gif/E___7400ZH00SIGG.gif' , 'title': '右哼哼'},
	{'src':'http://www.sinaimg.cn/uc/myshow/blog/misc/gif/E___7400ZH00SIGG.gif' , 'title': '右哼哼'},
...
//发达编辑范围
SinaEditor.plugins.add('resize',function(args){
	
	var editor = this;
    //    SinaEditor.operation.bold = function(ceditor){
    //		if(editor.getState() != SinaEditor.STATE.EDITING) {
    //			return;
    //		}
    //        SinaEditor.operation.save(ceditor);
    //        var ranges = SinaEditor.range.getCurrentRanges(ceditor.entyWin);
    //        for (var i = 0; ranges[i]; i++) {
    //            var range = ranges[i];
    //            var strong = SinaEditor.util.dom.createDom('strong', {
    //                'ownerDocument': ceditor.entyDoc
    //            });
    //            range.surroundContents(strong);
    //        }
    //        SinaEditor.range.applyRanges(ceditor.entyWin, ranges);
    //        SinaEditor.operation.save(ceditor);
    //    };
    
    var _dragManager = {};
    
    var doc = editor.enty.ownerDocument;
    var div = SinaEditor.util.dom.createDomFromHTML('<button id="lalalalaa" style="position:relative;">点击扩大</button>', doc);
	div.style.left = editor.enty.parentNode.offsetWidth/2 + 'px';
    editor.enty.parentNode.appendChild(div);
    _dragManager[editor.option.id] = div;
    
    return {
        "events": [{
            "element": _dragManager[editor.option.id],
            "events": {
                'click': function(e){
					e = SinaEditor.ev.fixEvent(e);
					var parent = editor.enty.parentNode;
